Ext.define('ExtjsSampleApp.view.main.MainViewModel', {
	extend: 'Ext.app.ViewModel',
	alias: 'viewmodel.mainviewmodel',
	data: {
		name: 'Extjs Sample App',
		navCollapsed:       false,
		...
		menu: {
          ...
          { "text": "Home", "iconCls": "x-fa fa-home", "xtype": "homeview", "leaf": true },
					{ "text": "Personnel", "iconCls": "x-fa fa-table", "xtype": "personnelview","leaf": true },
					  { "text": "Contact US", "iconCls": "x-fa fa-table", "xtype": "ContactUs", "leaf": true },
					{ "text": "About US", "iconCls": "x-fa fa-table", "xtype": "AboutUs","leaf": true },
